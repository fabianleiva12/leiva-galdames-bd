    ...
    <body>
        <form action="ingreso_cliente" name="inclientes" method="post">
            <table border="1" id="table">
                ...
                <td><input size="50" type="text" id="rut1" value="" name="rut" onkeyup="Valida_Rut();" ></td></tr>

                <tr align="left"><td>Nombre</td>
                <td><input size="50" type="text" value="" id="nombre1_id" name="nombre" onkeyup="allLetter(document.inclientes.nombre1_id);" ></td></tr>
