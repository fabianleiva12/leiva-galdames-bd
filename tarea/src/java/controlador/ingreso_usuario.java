 ...
 * @author Furious
 */
public class ingreso_usuario extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            registro_usuario regis1=new registro_usuario();

            String rut=request.getParameter("rut1").toUpperCase();
            String contrasena=request.getParameter("contrasena").toUpperCase();
            String nombre=request.getParameter("nombre1").toUpperCase();
